...
//start NCSU
 //  class MockProfileDelegate : public Profile::Delegate {
  //  public: void OnProfileCreated(Profile* me, bool flagone, bool flagtwo);
  //  };
  // void OnProfileCreated(Profile* profile,bool success,bool is_new_profile) {std::string test="test";}
//end NCSU
 ...
 private:
  ...
  //start NCSU
  Profile* CreateNewProfile() const;
  //end NCSU
